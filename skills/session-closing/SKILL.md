...
description: This skill should be used when the user asks to "close session", "end session", "session closing", "/closing", "wrap up", "/wrap", "document learnings", "what should I commit", or wants to analyze completed work before ending a coding session.
version: 2.0.0
---

# Session Closing Skill
