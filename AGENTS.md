...
plugin-mh는 MH의 커스텀 Claude Code 플러그인이다. 27개 스킬 + 2개 에이전트를 제공하며, 변환 어댑터(`codex/`) 를 통해 OpenAI Codex CLI에서도 동일한 기능을 29개 슬래시 커맨드로 사용할 수 있다.
...
| [codex/AGENTS.md](./codex/AGENTS.md) | Codex 29개 슬래시 커맨드 카탈로그 + 자연어 트리거 매핑 |
