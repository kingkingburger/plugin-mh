# /harness — Harness Engineering: 프로젝트 하네스 구축

프로젝트의 엔지니어링 문서 체계를 인터뷰 → 코드 분석 → 병렬 생성으로 한번에 구축한다.
...
Phase 2: 코드베이스 분석 (기존 프로젝트)
  ↓
Phase 3: 문서 병렬 생성 (Group A / B / C 별개 단계)
  ↓
Phase 4: 보고
```
...
인터뷰 답변 + 코드 분석 결과를 context로 하여 **3개 Group 작업을 별개 단계로 처리**한다.
