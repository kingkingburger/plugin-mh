...
│                                                             │
│  3. WebSearch                                               │
│     → 커뮤니티 의견 수집 (Reddit, HN, Dev.to 등)              │
│                                                             │
│  4. Skill: agent-arena                                      │
│     → 다관점 에이전트 토론으로 전문가 관점 수집                  │
│                                                             │
│  5. [선택] Context7 MCP                                     │
│     → 라이브러리별 최신 문서 조회                              │
└─────────────────────────────────────────────────────────────┘
...
| Skill | 용도 | 호출 방법 |
|-------|------|-----------|
| `agent-arena` | 다관점 에이전트 토론 | `Skill: agent-arena` |
